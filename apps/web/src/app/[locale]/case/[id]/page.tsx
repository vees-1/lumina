    ...
    <div className="relative bg-white rounded-2xl border border-black/[0.06] overflow-hidden">
      ...
      <div className="p-6 max-h-[500px] overflow-y-auto print:max-h-none print:overflow-visible print:p-0 print:m-0 print:border-none">
        ...
        <div className="hidden print:block mt-12 pt-8 border-t border-black/10">
          ...
          <p className="mt-2 font-bold font-sans">Dr. ________________________</p>
          <p className="text-[10pt] text-muted-foreground font-sans">Clinical Specialist</p>
          <p className="text-[8pt] text-muted-foreground mt-4 font-sans">Document generated by Lumina • {new Date().toLocaleDateString()}</p>
        </div>
        <div ref={endRef} />
      </div>
    </div>

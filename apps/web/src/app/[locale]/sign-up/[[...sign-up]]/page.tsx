...
function RoleGate({ onSelect }: { onSelect: (role: "doctor" | "patient") => void }) {
  return (
    <div className="w-full">
      <p className="text-[13px] font-bold uppercase tracking-[0.12em] text-[#8a91a2]">Before registration</p>
      ...
      <p className="mt-3 text-[15px] leading-7 text-[#62687a]">
        This sets the first Lumina workspace for your account.
      </p>
      <div className="mt-7 grid gap-3">
        ...
        >
          ...
          <span className="mt-1 block text-[14px] text-[#62687a]">Use the doctor workflow: evidence, HPO approval, scoring, letters.</span>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <span className="mt-1 block text-[14px] text-[#62687a]">Use patient pre-intake and wait for doctor approval.</span>
        </button>
      </div>
    </div>
  );
